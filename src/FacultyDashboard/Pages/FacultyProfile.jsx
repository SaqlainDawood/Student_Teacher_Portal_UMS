            ...
            <MDBCardBody className="">
              <div className="d-flex justify-content-between align-items-center mb-4">
                <h3 className="text-info fw-bold">
                  <i className="fas fa-user me-2"></i>Faculty Information{" "}
                </h3>
                <button
              ...
              >
                ...
                <MDBTableBody>
                  ...
                  <tr>
                    ...
                    <td className="text-success fw-bold">{faculty?.phone}</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td className="text-success fw-bold">{faculty?.city}</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td className="text-ternary fw-bold">
                  ...
                  <tr className="table-success">
                    <th colSpan={4} className="text-center">
                      {" "}
                      <i className="fas fa-wallet me-2"></i> Financial
                      Information
                    </th>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <th> User Name</th>
                    <td colSpan={3} className="text-success fw-bold">
                      {faculty?.userName}
                    </td>
                  </tr>
                </MDBTableBody>
