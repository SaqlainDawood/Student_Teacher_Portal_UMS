...
export default function Signup() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const res = await StaffAPI.post("/staff/signup", {
      ...
      if (res.data?.success) {
        ...
        setTimeout(() => navigate("/staff/apply/login"), 2000);
      }
    } catch (err) {
      const msg =
      ...
      <div className="relative md:w-1/2 flex flex-col justify-between px-8 py-10 md:px-16 md:py-16 overflow-hidden">
        ...
        <div className="relative max-w-md">
          ...
          <p className="mt-5 text-slate-300 text-base leading-relaxed">
            Create your account to browse open positions and submit your
            application in a few guided steps.
          </p>
